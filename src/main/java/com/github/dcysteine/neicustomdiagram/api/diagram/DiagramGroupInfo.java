...
public abstract class DiagramGroupInfo {
    ...
    /**
     * Used as this diagram group's unique identifier, as well as the key to look up all diagrams in a diagram group.
     */
     ...
     *
     * <p>
     * A full page allows diagrams with up to 14 rows of slots; see {@link Grid#TOTAL_HEIGHT} for the height in pixels.
     * Smaller resolutions will have less space, though.
     */
     ...
     *
     * <p>
     * Diagrams that this predicate returns {@code true} for will be filtered out.
     */
     ...
     *
     * <p>
     * The special value {@link DiagramGroupVisibility#DISABLED} will cause this diagram group to not be generated at
     * all, saving CPU and RAM usage.
     */
    public abstract DiagramGroupVisibility defaultVisibility();

    /**
     * A description of what this diagram group does; will be added to the visibility config comment.
     *
     * <p>
