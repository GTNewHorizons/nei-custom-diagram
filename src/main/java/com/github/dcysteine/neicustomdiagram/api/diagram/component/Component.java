 ...
 *
 * <p>
 * Each {@code Component} contains either an {@link Item} or a {@link Fluid}. This class is intended to help with
 * comparing different types of items and fluids, ignoring concrete details such as stack size. NBT is however included
 * in this class, as it is sometimes a concrete detail (e.g. enchantments) and sometimes part of the definition of an
 * item type.
 */
public interface Component extends Comparable<Component> {
    ...
    /**
     * Returns an {@link ItemStack} or {@link FluidStack} with the specified stack size, depending on the component
     * type.
     */
    Object stack(int stackSize);

    /**
     * Returns an {@link ItemStack} or {@link FluidStack} with the specified stack size and NBT, depending on the
     * component type.
     */
