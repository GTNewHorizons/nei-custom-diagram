...
/**
 * Implementation of {@link DiagramMatcher} that makes it more convenient to construct custom instances.
 */
public class CustomDiagramMatcher implements DiagramMatcher {
    ...
    public CustomDiagramMatcher(Iterable<? extends Diagram> allDiagrams,
    ...
    /**
     * This constructor is intended for use with diagram generators that generate their diagrams dynamically, and
     * therefore does not support {@link #all()}.
     *
     * <p>
     * Dynamic diagram generation is a good choice if:
     * <ul>
     * <li>The diagram should be displayed for a very large number of components (e.g. some debug information that
     * should be shown for most items).
     * <li>It is infeasible to compute the complete set of all diagrams that will be needed (e.g. it's difficult or
     * impossible to find all components that should have a diagram).
     * </ul>
     */
