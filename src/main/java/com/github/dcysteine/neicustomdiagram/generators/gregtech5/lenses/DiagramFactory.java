...
class DiagramFactory {
    ...
    void buildDiagram(
        ...
        Diagram.Builder.SlotGroupAutoSubBuilder slotGroupSubBuilder =
                diagramBuilder.autoInsertIntoSlotGroup(LayoutHandler.SlotGroupKeys.SAME_COLOUR_LENSES);
            ...
            if (sameColourLens.equals(lens)) {
                displayComponentBuilder
                        ...
                        .setAdditionalTooltip(Tooltip.create(
                                Lang.GREGTECH_5_LENSES.trans("currentlenslabel"), Tooltip.INFO_FORMATTING));
            }
        ...
        for (int i = 0; i < recipes.size(); i++) {
            ...
            if (recipeHandler.isColourRecipe(lens.colour(), recipe)) {
                inputBuilder.setAdditionalTooltip(Tooltip.create(
                ...
                inputBuilder
                        .setAdditionalInfo("*")
                        .setAdditionalTooltip(Tooltip.create(
                                Lang.GREGTECH_5_LENSES.trans("specificrecipelabel"), Tooltip.INFO_FORMATTING));
            }
