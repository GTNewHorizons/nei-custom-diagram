...
class LayoutHandler {
    ...
    private Layout buildHeaderLayout() {
        return Layout.builder().addInteractable(new AllDiagramsButton(info, Grid.GRID.grid(0, 0))).build();
    }
    ...
    private Layout buildFluidsLayout() {
        return Layout.builder().putSlotGroup(
                ...
                SlotGroup.builder(2, 2, Grid.GRID.grid(1, 3), Grid.Direction.C).setDefaultTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("fluidsslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildCrackedFluidsLayout() {
        return Layout.builder().addLines(
                Lines.builder(Grid.GRID.grid(1, 3)).addSegment(Grid.GRID.grid(3, 3)).addSegment(Grid.GRID.grid(3, 2))
                        .addArrow(Grid.GRID.edge(4, 2, Grid.Direction.W)).move(Grid.GRID.grid(3, 3))
                        .addSegment(Grid.GRID.grid(3, 4)).addArrow(Grid.GRID.edge(4, 4, Grid.Direction.W)).build())
                .putSlotGroup(
    ...
    private Layout buildNanitesLayout() {
        return Layout.builder().putSlot(
                ...
                Slot.builder(Grid.GRID.grid(0, 6)).setTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("nanitesslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildDustsLayout() {
        return Layout.builder().putSlotGroup(
                SlotGroupKeys.DUSTS,
                SlotGroup.builder(1, 3, Grid.GRID.grid(0, 8), Grid.Direction.S).setDefaultTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("dustsslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildHotIngotLayout() {
        return Layout.builder()
                .addLines(Lines.builder(Grid.GRID.grid(2, 6)).addArrow(Grid.GRID.edge(2, 8, Grid.Direction.N)).build())
                .putSlot(
                        SlotKeys.HOT_INGOT,
    ...
    private Layout buildRodsLayout() {
        return Layout.builder().putSlotGroup(
                SlotGroupKeys.RODS,
                SlotGroup.builder(1, 2, Grid.GRID.grid(0, 14), Grid.Direction.S).setDefaultTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("rodsslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildBoltsLayout() {
        return Layout.builder().putSlotGroup(
                SlotGroupKeys.BOLTS,
                SlotGroup.builder(1, 2, Grid.GRID.grid(2, 14), Grid.Direction.S).setDefaultTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("boltsslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildRingLayout() {
        return Layout.builder().putSlot(
                SlotKeys.RING,
                Slot.builder(Grid.GRID.grid(4, 14)).setTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("ringslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildRoundLayout() {
        return Layout.builder().putSlot(
                SlotKeys.ROUND,
                Slot.builder(Grid.GRID.grid(4, 16)).setTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("roundslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildSpringsLayout() {
        return Layout.builder().putSlotGroup(
                ...
                SlotGroup.builder(1, 2, Grid.GRID.grid(6, 14), Grid.Direction.S).setDefaultTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("springsslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildGearsLayout() {
        return Layout.builder().putSlotGroup(
                SlotGroupKeys.GEARS,
                SlotGroup.builder(1, 2, Grid.GRID.grid(8, 14), Grid.Direction.S).setDefaultTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("gearsslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildRotorLayout() {
        return Layout.builder().putSlot(
                SlotKeys.ROTOR,
                Slot.builder(Grid.GRID.grid(10, 14)).setTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("rotorslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildCasingLayout() {
        return Layout.builder().putSlot(
                SlotKeys.CASING,
                Slot.builder(Grid.GRID.grid(10, 16)).setTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("casingslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildBarsLayout() {
        return Layout.builder().putSlot(
                SlotKeys.BARS,
                Slot.builder(Grid.GRID.grid(12, 14)).setTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("barsslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildWiresLayout() {
        return Layout.builder().putSlotGroup(
                SlotGroupKeys.WIRES,
                SlotGroup.builder(3, 2, Grid.GRID.grid(2, 20), Grid.Direction.S).setDefaultTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("wiresslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildFineWireLayout() {
        return Layout.builder().putSlot(
                SlotKeys.FINE_WIRE,
                Slot.builder(Grid.GRID.grid(2, 18)).setTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("finewireslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildCablesLayout() {
        return Layout.builder()
                .addLines(
                        Lines.builder(Grid.GRID.grid(2, 22)).addArrow(Grid.GRID.edge(2, 24, Grid.Direction.N)).build())
                .putSlotGroup(
    ...
    private Layout buildPipesLayout() {
        return Layout.builder().putSlotGroup(
                SlotGroupKeys.PIPES,
                SlotGroup.builder(3, 2, Grid.GRID.grid(10, 20), Grid.Direction.S).setDefaultTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_PARTS.trans("pipesslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildSpecialPipesLayout() {
        return Layout.builder().addLines(
                Lines.builder(Grid.GRID.grid(10, 22)).addArrow(Grid.GRID.edge(10, 24, Grid.Direction.N)).build())
                .putSlotGroup(
