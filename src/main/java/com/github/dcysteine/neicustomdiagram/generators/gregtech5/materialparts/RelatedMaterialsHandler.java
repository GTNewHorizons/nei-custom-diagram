...
class RelatedMaterialsHandler {
    ...
    /**
     * There are some materials that have related materials set, but don't actually have any ore prefixes registered or
     * are dummy materials.
     */
    private static final ImmutableSet<Materials> EXCLUDED_MATERIALS = ImmutableSet
            .of(Materials.AnyCopper, Materials.AnyIron, Materials.Peanutwood);
    ...
    void initialize() {
        SetMultimap<Materials, Materials> relatedMaterials = MultimapBuilder.hashKeys().hashSetValues().build();
        ...
        SetMultimap<Materials, Materials> reversed = MultimapBuilder.hashKeys().hashSetValues().build();
        ...
        SetMultimap<Materials, Materials> propagated = MultimapBuilder.hashKeys().hashSetValues().build();
        for (Materials key : relatedMaterials.keys()) {
