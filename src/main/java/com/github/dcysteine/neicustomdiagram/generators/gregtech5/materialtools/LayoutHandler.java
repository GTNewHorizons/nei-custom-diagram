...
class LayoutHandler {
    ...
    private Layout buildToolPartsLayout() {
        return Layout.builder().putSlotGroup(
                ...
                SlotGroup.builder(4, 4, Grid.GRID.grid(6, 6), Grid.Direction.NE).setDefaultTooltip(
                        Tooltip.create(Lang.GREGTECH_5_MATERIAL_TOOLS.trans("toolpartsslot"), Tooltip.SLOT_FORMATTING))
                        .build())
                .build();
    }
    ...
    private Layout buildToolsLayout() {
        return Layout.builder()
                .addLines(Lines.builder(Grid.GRID.grid(6, 6)).addArrow(Grid.GRID.edge(6, 8, Grid.Direction.N)).build())
                .putSlotGroup(
                        SlotGroupKeys.TOOLS,
    ...
    private Layout buildTurbinesLayout() {
        return Layout.builder()
                .addLines(Lines.builder(Grid.GRID.grid(0, 2)).addArrow(Grid.GRID.edge(2, 2, Grid.Direction.W)).build())
                .putSlotGroup(
    ...
    private Layout buildScannersLayout() {
        return Layout.builder()
                .addLines(Lines.builder(Grid.GRID.grid(4, 19)).addSegment(Grid.GRID.grid(10, 19)).build())
                .putSlotGroup(
