...
class LayoutHandler {
    ...
    static final class SlotGroupKeys {
        ...
        static final Layout.SlotGroupKey CRUSHED_ORE_BATH_MERCURY = Layout.SlotGroupKey
                .create("crushed-ore-bath-mercury");
        static final Layout.SlotGroupKey CRUSHED_ORE_BATH_SODIUM_PERSULFATE = Layout.SlotGroupKey
                .create("crushed-ore-bath-sodium-persulfate");
        ...
        static final Layout.SlotGroupKey PURIFIED_DUST_CENTRIFUGE = Layout.SlotGroupKey
    ...
    private Layout buildCrushedOreMacerateLayout() {
        ...
        SlotGroup outputSlots = SlotGroup.builder(1, 2, Grid.GRID.grid(2, 14), Grid.Direction.S)
                .setDefaultTooltip(
                        Tooltip.create(Lang.GREGTECH_5_ORE_PROCESSING.trans("maceratorslot"), Tooltip.SLOT_FORMATTING))
                .build();

        return Layout.builder().addLines(lines).addInteractable(label)
                .putSlotGroup(SlotGroupKeys.CRUSHED_ORE_MACERATE, outputSlots).build();
    }
    ...
    private Layout buildCrushedOreWashLayout() {
        ...
        CustomInteractable label = labelHandler
                .buildLabel(LabelHandler.ItemLabel.ORE_WASHING_PLANT, Grid.GRID.grid(8, 8));

        SlotGroup outputSlots = SlotGroup.builder(1, 2, Grid.GRID.grid(8, 10), Grid.Direction.S).setDefaultTooltip(
                Tooltip.create(Lang.GREGTECH_5_ORE_PROCESSING.trans("orewashingplantslot"), Tooltip.SLOT_FORMATTING))
                .build();

        return Layout.builder().addLines(lines).addInteractable(label)
                .putSlotGroup(SlotGroupKeys.CRUSHED_ORE_WASH, outputSlots).build();
    }
    ...
    private Layout buildCrushedOreBathMercuryLayout() {
        ...
        SlotGroup outputSlots = SlotGroup.builder(1, 3, Grid.GRID.grid(0, 6), Grid.Direction.N).setDefaultTooltip(
                Tooltip.create(Lang.GREGTECH_5_ORE_PROCESSING.trans("chemicalbathslot"), Tooltip.SLOT_FORMATTING))
                .setSlot(
                        0,
                        0,
                        SlotGroup.slotBuilder()
                                .setTooltip(
                                        Tooltip.create(
                                                Lang.GREGTECH_5_ORE_PROCESSING.trans("chemicalbathfluidslot"),
                                                Tooltip.SLOT_FORMATTING))
                                .build())
                .build();

        return Layout.builder().addLines(lines).addInteractable(label)
                .putSlotGroup(SlotGroupKeys.CRUSHED_ORE_BATH_MERCURY, outputSlots).build();
    }
    ...
    private Layout buildCrushedOreBathSodiumPersulfateLayout() {
        ...
        SlotGroup outputSlots = SlotGroup.builder(1, 3, Grid.GRID.grid(2, 6), Grid.Direction.N).setDefaultTooltip(
                Tooltip.create(Lang.GREGTECH_5_ORE_PROCESSING.trans("chemicalbathslot"), Tooltip.SLOT_FORMATTING))
                .setSlot(
                        0,
                        0,
        ...
        return Layout.builder().addLines(lines).addInteractable(label)
                .putSlotGroup(SlotGroupKeys.CRUSHED_ORE_BATH_SODIUM_PERSULFATE, outputSlots).build();
    }
    ...
    private Layout buildPurifiedOreMacerateLayout() {
        Lines lines = Lines.builder(Grid.GRID.grid(8, 10)).addSegment(Grid.GRID.grid(10, 10))
                .addArrow(Grid.GRID.edge(10, 14, Grid.Direction.N)).build();

        CustomInteractable label = labelHandler.buildLabel(LabelHandler.ItemLabel.MACERATOR, Grid.GRID.grid(10, 12));

        SlotGroup outputSlots = SlotGroup.builder(1, 2, Grid.GRID.grid(10, 14), Grid.Direction.S)
                .setDefaultTooltip(
                        Tooltip.create(Lang.GREGTECH_5_ORE_PROCESSING.trans("maceratorslot"), Tooltip.SLOT_FORMATTING))
                .build();

        return Layout.builder().addLines(lines).addInteractable(label)
                .putSlotGroup(SlotGroupKeys.PURIFIED_ORE_MACERATE, outputSlots).build();
    }
    ...
    private Layout buildPurifiedOreSiftLayout() {
        ...
        return Layout.builder().addLines(lines).addInteractable(label)
                .putSlotGroup(SlotGroupKeys.PURIFIED_ORE_SIFT, outputSlots).build();
    }

    private Layout buildImpureDustCentrifugeLayout() {
        Lines lines = Lines.builder(Grid.GRID.grid(2, 14)).addSegment(Grid.GRID.grid(0, 14))
                .addArrow(Grid.GRID.edge(0, 16, Grid.Direction.N)).build();

        CustomInteractable label = labelHandler.buildLabel(LabelHandler.ItemLabel.CENTRIFUGE, Grid.GRID.grid(0, 14));

        SlotGroup outputSlots = SlotGroup.builder(1, 2, Grid.GRID.grid(0, 16), Grid.Direction.S)
                .setDefaultTooltip(
                        Tooltip.create(Lang.GREGTECH_5_ORE_PROCESSING.trans("centrifugeslot"), Tooltip.SLOT_FORMATTING))
                .build();

        return Layout.builder().addLines(lines).addInteractable(label)
                .putSlotGroup(SlotGroupKeys.IMPURE_DUST_CENTRIFUGE, outputSlots).build();
    }

    private Layout buildPurifiedDustCentrifugeLayout() {
        Lines lines = Lines.builder(Grid.GRID.grid(10, 14)).addSegment(Grid.GRID.grid(8, 14))
                .addArrow(Grid.GRID.edge(8, 16, Grid.Direction.N)).build();

        CustomInteractable label = labelHandler.buildLabel(LabelHandler.ItemLabel.CENTRIFUGE, Grid.GRID.grid(8, 14));

        SlotGroup outputSlots = SlotGroup.builder(1, 2, Grid.GRID.grid(8, 16), Grid.Direction.S)
                .setDefaultTooltip(
                        Tooltip.create(Lang.GREGTECH_5_ORE_PROCESSING.trans("centrifugeslot"), Tooltip.SLOT_FORMATTING))
                .build();

        return Layout.builder().addLines(lines).addInteractable(label)
                .putSlotGroup(SlotGroupKeys.PURIFIED_DUST_CENTRIFUGE, outputSlots).build();
    }

    private Layout buildPurifiedDustElectromagneticSeparateLayout() {
        Lines lines = Lines.builder(Grid.GRID.grid(10, 14)).addSegment(Grid.GRID.grid(12, 14))
                .addArrow(Grid.GRID.edge(12, 12, Grid.Direction.S)).build();

        CustomInteractable label = labelHandler
                .buildLabel(LabelHandler.ItemLabel.ELECTROMAGNETIC_SEPARATOR, Grid.GRID.grid(12, 14));

        SlotGroup outputSlots = SlotGroup.builder(1, 3, Grid.GRID.grid(12, 12), Grid.Direction.N)
                .setDefaultTooltip(
                        Tooltip.create(
                                Lang.GREGTECH_5_ORE_PROCESSING.trans("electromagneticseparatorslot"),
                                Tooltip.SLOT_FORMATTING))
                .build();

        return Layout.builder().addLines(lines).addInteractable(label)
                .putSlotGroup(SlotGroupKeys.PURIFIED_DUST_ELECTROMAGNETIC_SEPARATE, outputSlots).build();
    }
    ...
    private Layout buildOreThermalCentrifugeLayout() {
        ...
        CustomInteractable label = labelHandler
                .buildLabel(LabelHandler.ItemLabel.THERMAL_CENTRIFUGE, Grid.GRID.grid(6, 12));

        SlotGroup outputSlots = SlotGroup.builder(1, 2, Grid.GRID.grid(6, 14), Grid.Direction.S).setDefaultTooltip(
    ...
    private Layout buildOreThermalCentrifugeMacerateLayout() {
        ...
        CustomInteractable label = labelHandler.buildLabel(LabelHandler.ItemLabel.MACERATOR, Grid.GRID.grid(4, 14));
    ...
    private Layout buildAdditionalRecipeOutputsLayout() {
        SlotGroup outputSlots = SlotGroup.builder(9, 2, Grid.GRID.grid(6, 20), Grid.Direction.S)
                .setDefaultTooltip(
                        Tooltip.create(
                                Lang.GREGTECH_5_ORE_PROCESSING.trans("additionalrecipeoutputsslot"),
                                Tooltip.SLOT_FORMATTING))
                .build();

        return Layout.builder().putSlotGroup(SlotGroupKeys.ADDITIONAL_RECIPE_OUTPUTS, outputSlots).build();
    }
}
