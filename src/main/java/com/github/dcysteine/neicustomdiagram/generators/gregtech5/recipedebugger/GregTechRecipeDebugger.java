...
public final class GregTechRecipeDebugger implements DiagramGenerator {
    ...
    public enum View {
        ...
        CONSUME_CIRCUIT_RECIPES(
                "-consume-circuit-recipes", ItemComponent.create(Items.blaze_powder, 0), "consumecircuitrecipesbutton"),
    ...
    public GregTechRecipeDebugger(String groupId) {
        this.info = DiagramGroupInfo.builder(Lang.GREGTECH_5_RECIPE_DEBUGGER.trans("groupname"), groupId, ICON, 1)
                ...
                .setDescription("This diagram checks for recipe collisions and various other recipe"
                        + " issues."
    ...
    public CustomDiagramGroup generate() {
        ...
        Arrays.stream(View.values())
                .forEach(view ->
                        customBehaviorMapBuilder.put(view.behaviorId(info), () -> diagramHandler.getDiagrams(view)));
