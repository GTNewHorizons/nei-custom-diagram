...
public final class Lang {
    ...
    public static final Lang ENDER_STORAGE_CHEST_OVERVIEW = new Lang(
            "neicustomdiagram.generators.enderstorage.chestoverview.");
    public static final Lang ENDER_STORAGE_TANK_OVERVIEW = new Lang(
            "neicustomdiagram.generators.enderstorage.tankoverview.");
    ...
    public static final Lang GREGTECH_5_MATERIAL_PARTS = new Lang(
            "neicustomdiagram.generators.gregtech5.materialparts.");
    public static final Lang GREGTECH_5_MATERIAL_TOOLS = new Lang(
            "neicustomdiagram.generators.gregtech5.materialtools.");
    public static final Lang GREGTECH_5_ORE_DICTIONARY = new Lang(
            "neicustomdiagram.generators.gregtech5.oredictionary.");
    public static final Lang GREGTECH_5_ORE_PREFIXES = new Lang("neicustomdiagram.generators.gregtech5.oreprefixes.");
    public static final Lang GREGTECH_5_ORE_PROCESSING = new Lang(
            "neicustomdiagram.generators.gregtech5.oreprocessing.");
    public static final Lang GREGTECH_5_RECIPE_DEBUGGER = new Lang(
