...
public final class Reflection {
    ...
    public static final ReflectionField<GuiContainer, Integer> GUI_LEFT = ReflectionField
            .createInteger(GuiContainer.class, "guiLeft", "field_147003_i");
    public static final ReflectionField<GuiContainer, Integer> GUI_TOP = ReflectionField
            .createInteger(GuiContainer.class, "guiTop", "field_147009_r");
    public static final ReflectionField<GuiContainer, Integer> X_SIZE = ReflectionField
            .createInteger(GuiContainer.class, "xSize", "field_146999_f");
    public static final ReflectionField<GuiContainer, Integer> Y_SIZE = ReflectionField
            .createInteger(GuiContainer.class, "ySize", "field_147000_g");
