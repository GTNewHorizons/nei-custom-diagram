...
public final class ConfigOptions {
    ...
    public static final Option<Boolean> SHOW_STACK_SIZE_ONE = new BooleanOption(
            ...
            "show_stack_size_one",
            false,
            "Enables always showing stack size on item components, even if it's 1.").register();
    ...
    public abstract static class Option<T> implements Supplier<T> {
        ...
        /**
         * Sadly, this abstract method is needed because we cannot in-line getting the property in {@link #initialize()}
         * due to type shenanigans.
         */
    ...
    static void setCategoryComments() {
        ...
        Arrays.stream(DiagramGroupVisibility.values()).forEach(
                visibility -> diagramGroupCategoryCommentBuilder.append("\n * ").append(visibility.toString()));
        Config.CONFIG
                .setCategoryComment(Category.DIAGRAM_GROUPS.toString(), diagramGroupCategoryCommentBuilder.toString());
    }
