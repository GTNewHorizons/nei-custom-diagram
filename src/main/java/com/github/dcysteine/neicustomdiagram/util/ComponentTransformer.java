...
/**
 * Class containing utility methods for comparing and converting between {@link Component} and {@link DisplayComponent}.
 */
public final class ComponentTransformer {
    ...
    public static List<Component> transformFromDisplay(Collection<DisplayComponent> displayComponents) {
        return displayComponents.stream().map(ComponentTransformer::transformFromDisplay).distinct()
                .collect(Collectors.toList());
    }

    /**
     * Returns whether {@code displayComponents} contains any elements that, when transformed to {@link Component}, are
     * equal to {@code component}.
     */
    public static boolean containsComponent(Collection<DisplayComponent> displayComponents, Component component) {
        return displayComponents.stream().anyMatch(displayComponent -> equals(displayComponent, component));
    }

    /**
     * Returns whether {@code components} contains any elements that are equal to {@code displayComponent} transformed
     * to {@link Component}.
     */
    public static boolean containsDisplayComponent(Collection<? extends Component> components,
            DisplayComponent displayComponent) {
        return components.stream().anyMatch(component -> equals(displayComponent, component));
    }

    /**
     * Returns whether {@code displayComponents} contains elements that, when transformed to {@link Component}, are
     * equal to all elements of {@code components}.
     */
    public static boolean containsAllComponents(Collection<DisplayComponent> displayComponents,
    ...
    /**
     * Returns whether {@code components} contains elements that are equal to all elements of {@code displayComponents}
     * transformed to {@link Component}.
     */
    public static boolean containsAllDisplayComponents(Collection<? extends Component> components,
     ...
     */
    public static boolean containsAllDisplayComponents(Collection<? extends Component> components,
            DisplayComponent... displayComponents) {
        return containsAllDisplayComponents(components, Arrays.asList(displayComponents));
    }

    /**
     * Removes all elements of {@code displayComponents} that, when transformed to {@link Component}, are equal to
     * {@code component}.
     *
    ...
    /**
     * Removes all elements of {@code components} that are equal to {@code displayComponent} transformed to
     * {@link Component}.
     *
     * @return whether any elements were removed
     */
    public static boolean removeDisplayComponent(Collection<? extends Component> components,
            DisplayComponent displayComponent) {
        return components.removeIf(component -> equals(displayComponent, component));
    }

    /**
     * Removes all elements of {@code displayComponents} that, when transformed to {@link Component}, are equal to any
     * element of {@code components}.
     *
     * @return whether any elements were removed
     */
    public static boolean removeAllComponents(Collection<DisplayComponent> displayComponents,
            Iterable<? extends Component> components) {
     ...
     * @return whether any elements were removed
     */
    public static boolean removeAllDisplayComponents(Collection<? extends Component> components,
            Iterable<DisplayComponent> displayComponents) {
        boolean anythingRemoved = false;
        for (DisplayComponent displayComponent : displayComponents) {
