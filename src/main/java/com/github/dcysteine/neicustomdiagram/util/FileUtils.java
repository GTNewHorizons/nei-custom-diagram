...
public class FileUtils {
    ...
    public static long getSize(File file, SizeUnit sizeUnit) {
        ...
        switch (sizeUnit) {
            case KB:
                return size / SizeUnit.KB.getSize();
            case MB:
                return size / SizeUnit.MB.getSize();
            case GB:
                return size / SizeUnit.GB.getSize();
            default:
                return size;
        }
    }
